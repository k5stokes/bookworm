	...
	<section>
		...
		<div id="friendsList" class="">
			...
			?>
				...
				<form action="#" method="post" id="remove_friends_form" name="remove_friends_form" class="flex wrap gap-40">
			<?php
					$friend_ids = array();
			...
			?>
					<input id="remove_friend_id" type="hidden" name="remove_friend_id" value="">
